"""Direct test of signup logic with new email."""
import sys
import traceback
...
def test_signup_direct():
    ...
    test_email = "jenharaj0126@gmail.com"
    test_password = "Test@123"
    
    print(f"Testing signup for NEW email: {test_email}")
    ...
    try:
        with Session(engine) as session:
            ...
            print(f"[OK] Hashed password: {password_hash[:20]}...")
