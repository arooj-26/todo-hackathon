  ...
  return (
    <div style={{
      ...
      >
        ...
        <div className="card-dark p-8 space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            >
              ...
              <p className="text-white/60 text-sm">
                Sign up to get started with TodoFlow
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="btn-gradient-pink w-full py-3 rounded-lg font-semibold text-white flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        >
          TodoFlow - Manage your tasks beautifully
        </motion.p>
      </motion.div>
    </div>
  )
